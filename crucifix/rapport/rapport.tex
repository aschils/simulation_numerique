...
\begin{equation}
 \ln(\delta x) = -kt + \ln(\delta x_{0})\;.\label{pertu}
\end{equation}

On a donc:

\begin{equation}
\lambda_{max}= \lim_{t\rightarrow_{\infty}}\frac{1}{t} \ln(\left\|\delta \vec{x} \right\|) = \lim_{t\rightarrow_{\infty}}\frac{1}{t} \ln(\delta x)= \lim_{t\rightarrow_{\infty}}\left(\frac{-kt+\ln(\delta x_{0})}{t}\right)= -k\;.
\end{equation}
