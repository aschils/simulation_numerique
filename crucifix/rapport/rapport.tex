...
\begin{tikzpicture}
  ...
  \stencilpt{0, 2}{ij+1}{$x_i,t_{j+1}$};
  \stencilpt{0, 1}{ij}{$x_i,t_{j}$};
  \stencilpt{-2, 1}{i-1j}{$x_{i-1},t_{j}$};
  \stencilpt{2, 1}{i+1j}{$x_{i+1},t_{j}$};
  \stencilpt{0,0}{ij-1}{$x_i,t_{j-1}$};
  \stencilpt{2,0}{i+1j-1}{$x_{i+1},t_{j-1}$};
  \stencilpt{-2,0}{i-1j-1}{$x_{i-1},t_{j-1}$};
  \stencilpt{4,0}{i+2j-1}{$x_{i+2},t_{j-1}$};
  \stencilpt{-4,0}{i-2j-1}{$x_{i-2},t_{j-1}$};
  \stencilpt{-6,-1}{l}{$x_i-(j+1)h, t_0$};
  \stencilpt{-4,-1}{l2}{};
  \stencilpt{-2,-1}{l3}{};
  \stencilpt{0,-1}{l4}{$x_i, t_0$};
  \stencilpt{2,-1}{l5}{};
  \stencilpt{4,-1}{l6}{};
  \stencilpt{6,-1}{l7}{$x_i+(j+1)h, t_0$};
