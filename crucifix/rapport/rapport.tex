...
\subsection*{schéma non dispersif}

La vitesse de groupe numérique n'est pas fonction de $\bar{k}$, elle est égale à une constante $a$ dans notre approximation. Notre schéma n'est donc pas dispersif. Ce qui est cohérent avec notre système originel qui est non dispersif $v_{g} = a $.
