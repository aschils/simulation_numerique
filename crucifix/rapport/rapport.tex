...
w(t) = \sum_{n=1}^{\infty} C_{2_n} e^{C_1 t}
\end{align}
...
\begin{equation}
u(x,t) = \sum_{m=1}^{\infty} C_m \sin \left (\frac{m \pi x}{l} \right ) e^{\alpha x} e^{C_1 t}
\end{equation}
...
\begin{equation}
  \rho = a^2 + 4D (C_1 +b) \implies C_1 = \frac{\rho-a^2}{4D}-b
\end{equation}
...
\begin{equation}
  \boxed{C_m = \frac{2}{l} \int_0^l g(x) \sin \left (\frac{m \pi x}{l} \right ) e^{-\alpha x} dx}
\end{equation}
